  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity onPress={() => {setImg(require("../assets/vs_silver.png")); setColor("Bạc");}}>
          <View style={styles.silver}></View>
        </TouchableOpacity>

        <TouchableOpacity style={styles.black} onPress={() => {setImg(require("../assets/vs_black.png")); setColor("Đen")}}>
          <View></View>
        </TouchableOpacity>

        <TouchableOpacity onPress={() => {setImg(require("../assets/vs_blue.png")); setColor("Xanh");}}>
          <View style={styles.blue}></View>
        </TouchableOpacity>

        <TouchableOpacity onPress={() => {setImg(require("../assets/vs_red.png")); setColor("Đỏ");}}>
